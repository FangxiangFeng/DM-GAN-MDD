...
def _compute_statistics_of_path(path, model, batch_size, dims, cuda, image_height, image_width):
    if path.endswith('.npz'):
        ...
        # np.savez_compressed('coco_vd_val.npz', mu=m, sigma=s)
    return m, s

def calculate_fid_given_paths(paths, batch_size, cuda, dims, image_height, image_width):
    ...
    m1, s1 = _compute_statistics_of_path(paths[0], model, batch_size, dims, cuda, image_height, image_width)
    m2, s2 = _compute_statistics_of_path(paths[1], model, batch_size, dims, cuda, image_height, image_width)
...
if __name__ == '__main__':
    ...
    paths[1] = args.path2
    print(paths)
    fid_value = calculate_fid_given_paths(paths, args.batch_size,args.gpu,args.dims, args.image_height, args.image_width)
    print('FID: ', fid_value)
